            ...
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        <label for="name" class="block text-black text-sm font-bold mb-2 sm:mb-4">
                            {{ __('Name') }}:
                        </label>
                    ...
                    <div class="flex flex-wrap">
                        <label for="password-confirm" class="block text-black text-sm font-bold mb-2 sm:mb-4">
                            {{ __('Confirm Password') }}:
                        </label>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <p class="w-full text-xs text-center text-black my-6 sm:text-sm sm:my-8">
                            ...
                            <a class="text-green-500 no-underline hover:underline" href="{{ route('login') }}">
                                {{ __('Login') }}
                            </a>
                        </p>
                    </div>
